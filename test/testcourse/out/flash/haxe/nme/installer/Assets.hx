...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("assets/testcourse.svg", NME_assets_testcourse_svg);
			resourceTypes.set ("assets/testcourse.svg", "text");
			resourceClasses.set ("assets/testcourse.xml", NME_assets_testcourse_xml);
			resourceTypes.set ("assets/testcourse.xml", "text");
